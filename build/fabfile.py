...
def production():
  fab.env.git = _deploy_git_factory()(
    remote_repository_path='/home/www/p461591/html/apps.janchristlieb.de',  # get this ready
...
def staging():
  fab.env.git = _deploy_git_factory()(
    remote_repository_path='/home/www/p461591/html/staging.apps.janchristlieb.de',  # get this ready
